...
## 15분 안에 시작하기: Quick Start Guide

> "뭐부터 해야 할지 모르겠어요. 폴더 구조도 복잡하고..."

많은 사용자들이 AI4PKM을 처음 접할 때 막막함을 느낀다. 완벽하게 이해하고 시작할 필요 없다. **일단 15분만 투자해서 시작해보자**.
...
> [!info] 폴더 구조는 나중에
> `Ingest/`, `AI/`, `Topics/` 등의 폴더 구조가 보일 것이다. 지금은 이해하지 않아도 된다.
> 중요한 건 **Ingest/** 폴더에 뭔가를 넣기 시작하는 것이다.

### Step 2: 웹 클리퍼 설치 (5분)

1. 브라우저에서 "Obsidian Web Clipper" 확장 프로그램 검색
2. 설치
3. 볼트 연결

이제 웹에서 읽은 글을 한 번의 클릭으로 저장할 수 있다.

### Step 3: 첫 클리핑 + 첫 일기 (5분)
...
**첫 일기**:
1. 옵시디언에서 `Journal/` 폴더 열기
2. 오늘 날짜로 새 노트 생성 (예: `2024-03-20.md`)
3. 한 줄만 쓰기: "오늘 AI4PKM을 시작했다"
...
**다음 단계**: 내일도 클리핑 1개 + 일기 한 줄. 그렇게 7일을 채우면 첫 주간 라운드업을 만들어볼 수 있다.

### 첫 발 디딘 후: 단계별 확장

| 단계 | 시기 | 할 일 |
|------|------|-------|
| **Week 1** | Day 1-7 | 매일 클리핑 1개 + 일기 한 줄 |
| **Week 2** | Day 8-14 | AI 요약 기능 시도 (EIC 프롬프트) |
| **Week 3** | Day 15-21 | 첫 주간 라운드업 생성 |
| **Week 4** | Day 22-28 | 토픽 연결 시작 |

> [!quote] 기억하세요
> "첫 번째 단계는 인제스트예요. 일단 외부에 있는 걸 넣어서 백지 상태를 탈출하는 거." - AI4PKM 코호트 멘토
