...
Apply specific writing styles when requested. Available style guides in `references/`:
- **하루키 Style Guide** - Conversational, observational, gentle philosophical reflection
- **윤광준 Style Guide** - Experience-based, honest confessional, practical wisdom
- **구본형 Style Guide** - Philosophical depth with everyday language, transformative messaging

Load the appropriate style guide when user requests a specific style (typically in PRW prompt).
...
2. Search for relevant readings in Reading/Ingest folders
...
**Purpose:** Translate English text to natural Korean.
...
2. 전체적으로 자연스럽고 개인적인 어조로 작성하고
   어색한 존대말은 쓰지 않는다 (기억나요>>기억난다/같았어요>>같았다)
...
**Usage:** Apply when user needs Korean translation with natural, personal tone.
